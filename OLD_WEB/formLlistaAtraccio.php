    ...
    <div class="content">
      <table >
        <tr>
          <th>Nom</th>
          <th>Tipus</th>
          <th>Data inauguració</th>
          <th>Zona del parc</th>
        </tr>
        <tr>
          <td><?php echo $a1->getNom();?></td>
          <td><?php echo $a1->getTipus();?></td>
          <td><?php echo $a1->getDataInauguracio();?></td>
          <td><?php echo $a1->getZona();?></td>
        </tr>
        <tr>
          <td><?php echo $a2->getNom();?></td>
          <td><?php echo $a2->getTipus();?></td>
          <td><?php echo $a2->getDataInauguracio();?></td>
          <td><?php echo $a2->getZona();?></td>
        </tr>
        <tr>
          <td><?php echo $a3->getNom();?></td>
          <td><?php echo $a3->getTipus();?></td>
          <td><?php echo $a3->getDataInauguracio();?></td>
          <td><?php echo $a3->getZona();?></td>
        </tr>
        <tr>
          <td><?php echo $a4->getNom();?></td>
          <td><?php echo $a4->getTipus();?></td>
          <td><?php echo $a4->getDataInauguracio();?></td>
          <td><?php echo $a4->getZona();?></td>
        </tr>
      </table>
    </div>
    </article>
