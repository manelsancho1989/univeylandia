...
<body>
  ...
  <section id="main-content">
    <article>
	  ...
	  <div class="content">
		<form method="post" action="GestioModAssignacio.php">
		  <label for="assignacio">Tria l'assignació que vols modificar:
        ...
        <option value="assign01"><?php echo $as1->getTreballadorAssignat()." - ".$as1->getAtraccioAssignada()." - ".$as1->getZonaParcAssign()." - ".$as1->getDataAssignacio();?></option>
			  <option value="assign02"><?php echo $as2->getTreballadorAssignat()." - ".$as2->getAtraccioAssignada()." - ".$as2->getZonaParcAssign()." - ".$as2->getDataAssignacio();?></option>
			  <option value="assign03"><?php echo $as3->getTreballadorAssignat()." - ".$as3->getAtraccioAssignada()." - ".$as3->getZonaParcAssign()." - ".$as3->getDataAssignacio();?></option>
			  <option value="assign04"><?php echo $as4->getTreballadorAssignat()." - ".$as4->getAtraccioAssignada()." - ".$as4->getZonaParcAssign()." - ".$as4->getDataAssignacio();?></option>
			</datalist>
