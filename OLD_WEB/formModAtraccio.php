...
<body>
  ...
  <section id="main-content">
    <article>
	  ...
	  <div class="content">
		<form method="post" action="GestioModAtraccio.php">
		  <label for="atraccio">Tria l'atracció que vols modificar:
			<input list="atraccio" name="atraccio" type="text" required>
		  </label>
