...
<body>
  ...
  <section id="main-content">
    <article>
      <header>
        <h1>Eliminar Assignació</h1>
      </header>
	  <div class="content">
		<form method="post" action="mensajeElimAssignacio.php">
		  <label for="assignacio">Tria l'assignació que vols eliminar:
			<input list="assignacio" name="assignacio" type="text" required>
		  </label>
      <datalist id="assignacio">
        <option value="assign01"><?php echo $as1->getTreballadorAssignat()." - ".$as1->getAtraccioAssignada()." - ".$as1->getZonaParcAssign()." - ".$as1->getDataAssignacio();?></option>
			  <option value="assign02"><?php echo $as2->getTreballadorAssignat()." - ".$as1->getAtraccioAssignada()." - ".$as1->getZonaParcAssign()." - ".$as1->getDataAssignacio();?></option>
			  <option value="assign03"><?php echo $as3->getTreballadorAssignat()." - ".$as1->getAtraccioAssignada()." - ".$as1->getZonaParcAssign()." - ".$as1->getDataAssignacio();?></option>
			  <option value="assign04"><?php echo $as4->getTreballadorAssignat()." - ".$as1->getAtraccioAssignada()." - ".$as1->getZonaParcAssign()." - ".$as1->getDataAssignacio();?></option>
			</datalist>
