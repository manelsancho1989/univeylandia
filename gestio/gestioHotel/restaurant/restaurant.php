...
<div class="row p-3 mb-2 bg-light text-dark">
  <div class="col-sm-5 py-5 px-5">
        <img src="../img/dorada.jpg" style="width:100%" >
  </div>
  <div class="col-sm-7 py-5 px-5">
    ...
    <ul class="list-unstyled">
      <li>Comencem Lleuger:
        <ul>
          <li>Amanida d’escarola, orella de porc cruixent i vinagreta de pinyons 15 €</li>
          <li>Amanida de tirabecs amb enciam, pernil ibèric i foie 19 €</li>
          <li>Amanida de guatlla escabetxada amb pasta i magrana 19 €</li>
          <li>Làmines de bacallà amb patata, anxoves i piparra 19 €</li>
          <li>Coca de foie amb poma caramel·litzada i amanida de contrastos 21 €</li>
          <li>Verdures escalivades amb anxoves i romesco 16 €</li>
          <li>Ostres lleugerament escabetxades amb verdures i algues 22 €</li>
          <li>Ostres al natural 4’5 €/unitat</li>
        </ul>
      </li>
    </ul>
  </div>
...
<div class="row p-3 mb-2 bg-light text-dark">
  <div class="col-sm-5 py-5 px-5">
        <img src="../img/espardenyes.jpg" style="width:100%" >
  </div>
  <div class="col-sm-7 py-5 px-5">


    <ul class="list-unstyled">
      <li>Entrants suculents:
        <ul>
          <li>Caneló de carbassó amb cranc i llagostins 24 €</li>
          <li>Ous ferrats amb cansalada, cotna cruixent i patates soufflé 17 €</li>
          <li>Moll de l’os a la brasa amb tartar de vedella i patates suflés 22 €</li>
          <li>Truita oberta amb pa amb tomàquet, pernil, escarola i emulsió de piquillo21 €</li>
          <li>Canelons de pollastre de pagès rostit amb bolets a la crema 26 €</li>
          <li>Ou a baixa temperatura amb verdures i migues de sobrassada 16 €</li>
          <li>Espardenyes amb cansalada i cremós de coliflor 42 €</li>
          <li>Orella de porc a la brasa amb trinxat i picada 15 €</li>
        </ul>
      </li>
    </ul>
  </div>
