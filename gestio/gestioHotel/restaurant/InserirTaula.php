      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <form class="needs-validation" action="../../../php/taulaPHP/inserirTaula.php" method="post">
            <div class="form-row">
              <div class="col-md-3 mb-3">
                <label for="cognom">Numero Taula</label>
                <input type="text" class="form-control form-control-sm" placeholder="Numero Taula" name="numTaula" required>
              </div>
              <div class="col-md-3 mb-3">
                <label for="cognom2">Numero Cadires</label>
                <input type="text" class="form-control form-control-sm" placeholder="Numero Cadires" name="numCadira" required>
              </div>
