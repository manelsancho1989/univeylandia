        ...
        <div class="row justify-content-center align-items-center">
            <div class="card" style="width: 22rem;">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item"><strong> Nom:</strong> Joan Manel</li>
                    <li class="list-group-item"><strong>Cognom:</strong> Sancho Garcia</li>
                    <li class="list-group-item"><strong> Data Naixement: </strong>08/10/1989</li>
                    <li class="list-group-item"><strong> Població: </strong>Sant Carles de la Ràpita</li>
                    <li class="list-group-item"><strong>Adreça: </strong>C/ Sant josep numero 27 pis 1</li>
                </ul>
                <div class="card-body">
                    <a href="#" class="btn btn-primary">Modificar Perfil</a>
                    <a href="#" class="btn btn-primary">Eliminar Perfil</a>
                </div>
            </div>
        </div>
    </div>
